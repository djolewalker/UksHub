...
class Label(TimeStampModel):
    ...
    color = models.CharField(max_length=7, blank=True, null=True, default=random_hex_color)
...
class WikiPageRevision(TimeStampModel):
    ...
    prev_revision = models.ForeignKey('hub.WikiPageRevision', on_delete=models.CASCADE)
